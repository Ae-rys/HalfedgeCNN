...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--feat_selection', type=int, choices={0, 1, 2, 3, 4}, help='Feature Selection to use. See extract_features_from_he in half_edge_mesh_prepare.py for details.')
